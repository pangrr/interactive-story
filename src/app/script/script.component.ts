...
export class ScriptComponent {
  ...
  constructor(
    ...
    iconRegistry.addSvgIcon('chevron_right', sanitizer.bypassSecurityTrustResourceUrl('assets/chevron_right.svg'));
    iconRegistry.addSvgIcon('expand_more', sanitizer.bypassSecurityTrustResourceUrl('assets/expand_more.svg'));
